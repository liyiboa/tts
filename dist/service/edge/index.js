...
exports.service = exports.Service = exports.FORMAT_CONTENT_TYPE = void 0;
const crypto_1 = require("crypto");
const ws_1 = require("ws");
exports.FORMAT_CONTENT_TYPE = new Map([
...
class Service {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            const connectionId = (0, crypto_1.randomBytes)(16).toString('hex').toLowerCase();
    ...
    convert(ssml, format) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.ws == null || this.ws.readyState != ws_1.WebSocket.OPEN) {
                console.info('准备连接服务器……');
                let connection = yield this.connect();
                this.ws = connection;
                console.info('连接成功！');
            }
            const requestId = (0, crypto_1.randomBytes)(16).toString('hex').toLowerCase();
            let result = new Promise((resolve, reject) => {
                ...
                let configMessage = `X-Timestamp:${Date()}\r\n` +
            ...
            let data = yield Promise.race([result, timeout]);
