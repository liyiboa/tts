...
module.exports = async (request: Request, response: Response) => {
  ...
  ttsarr['ttsdata'].forEach(item =>{
    ...
    let langstrend = '';
      ...
      let ssml =
        '<speak xmlns="http://www.w3.org/2001/10/synthesis" xmlns:tts="http://www.w3.org/2001/tts" xmlns:emo="http://www.w3.org/2009/10/emotionml" version="1.0" xml:lang="en-US">' +
